...
function historyScrollChecker(){
 	
 	window.doScroll = true;

  $("#history").on("hover", function(){
  	  
  	  if(window.historyScroll)
  	   {
  	    window.reading = true;  	    
  	   }
   ...
   $("#history").scroll(function(e){

   	  console.log(e);
   		   	
    
  if(window.reading ){
   		if(window.historyScroll < $(this).scrollTop())   			
   			 window.doScroll = false;   			 

   		if( window.historyScroll === $(this).scrollTop())
   			 {
   			 window.reading = false;
   			 window.historyScroll = false;
   			 window.doScroll = true;
   			 }
   			}

   	  console.log("scrolled");
   		window.historyScroll = $(this).scrollTop();
...
function autoScroll(){
	...
	console.log(window.doScroll);



	if (true){
				
		$('#history').scrollTop( logsH );		
